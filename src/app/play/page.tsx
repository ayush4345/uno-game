...
import { useAccount, useConnect, useDisconnect, useContractWrite, useWalletClient } from 'wagmi';
        ...
        try {
            ...
            if (connector) {
                ...
                toast({
                    ...
                    description: "Please use the Connect Wallet button to connect your wallet.",
                });
            }
        } catch (error) {
